...
Key:  pixel_values_vid
Shape: torch.Size([bs, 1, 3, 256, 256])

Key:  pixel_values_ref_img
Shape: torch.Size([bs, 1, 3, 256, 256])

Key:  pixel_values_face_mask
Shape: torch.Size([bs, 1, 3, 256, 256])

Key:  audio_feature
Shape: torch.Size([bs, 80, 3000])
